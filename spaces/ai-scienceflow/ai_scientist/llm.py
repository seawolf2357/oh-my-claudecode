...
def get_batch_responses_from_llm(
    ...
    elif model.startswith("accounts/fireworks/") or model.startswith("fireworks/"):
        actual_model = model[len("fireworks/"):] if model.startswith("fireworks/") else model
        new_msg_history = msg_history + [{"role": "user", "content": msg}]
        response = client.chat.completions.create(
            model=actual_model,
            messages=[
...
def create_client(model) -> tuple[Any, str]:
    if model.startswith("claude-"):
        ...
        client_model = model[len("fireworks/"):]
